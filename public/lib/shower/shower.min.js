...
!function (global) {
	...
	function initialize() {
		global.shower.modules.require("shower.defaultOptions", function (defaultOptions) {
			var hasOptions = global.hasOwnProperty("showerOptions"), options = global.shower.options, containerSelector = options.shower_selector || defaultOptions.container_selector, element = document.querySelector(containerSelector), getDataAttr = getData.bind(this, element), autoInit = "undefined" == typeof options.auto_init || options.auto_init;
	...
	extend(Shower.prototype, {
		destroy: function () {
			...
			var slidesParser = this.options.get("slides_parser") || defaultSlidesParser, slides = slidesParser(this.container.getElement(), this.options.get("slides_selector"));
			this.add(slides)
	...
	extend(Container.prototype, {
		init: function () {
			var bodyClassList = document.body.classList, showerOptions = this._shower.options, fullModeClass = showerOptions.get("mode_full_classname"), listModeClass = showerOptions.get("mode_list_classname");
			...
			var activeSlideClassName = this._shower.options.get("slide_active_classname"), slideElement = this._element.querySelector("." + activeSlideClassName);
	...
	extend(Location.prototype, {
		destroy: function () {
			...
			var title = document.title, isSlideMode = this._isSlideMode(), currentSlide = this._shower.player.getCurrentSlide();
	...
	extend(Layout.prototype, {
		init: function () {
			...
			var titleElementSelector = this.options.get("title_element_selector"), titleElement = this._element.querySelector(titleElementSelector);
	...
	extend(Next.prototype, {
		destroy: function () {
			...
			var elementsLength = this._elements.length, completed = (this._shower.container.isSlideMode(), this._innerComplete);
	...
	extend(Progress.prototype, {
		destroy: function () {
			...
			var slidesCount = this._shower.getSlidesCount(), currentSlideNumber = this._shower.player.getCurrentSlideIndex(), currentProgressValue = 100 / (slidesCount - 1) * currentSlideNumber;
